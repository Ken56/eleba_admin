        ...
        <div class="col-lg-6">
            <form enctype="multipart/form-data" method="POST" action="{{route('character.store')}}" >
                <div>
                    ...
                    <input type="text" name="name" value="{{old('name')}}" class="form-control" id="kk" placeholder="角色名称">
                </div>
                <div>
                    <label for="kk">显示名称</label>
                    <input type="text" name="display_name" value="{{old('display_name')}}" class="form-control" id="kk" placeholder="显示名称">
                </div>
                <div class="checkbox">
                ...
                <div>
                    ...
                    <textarea class="form-control" rows="3" name="description" id="" cols="30" rows="10">{{old('description')}}</textarea>
                </div>
